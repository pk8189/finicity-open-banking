...
class PrequalificationReportConstraints(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerPrequalificationReportConstraints(pydantic.BaseModel):
    """
    Serializer for PrequalificationReportConstraints handling case conversions
    and file omitions as dictated by the API
    """
