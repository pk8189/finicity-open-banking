...
class TransactionsReportConstraints(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerTransactionsReportConstraints(pydantic.BaseModel):
    """
    Serializer for TransactionsReportConstraints handling case conversions
    and file omitions as dictated by the API
    """
