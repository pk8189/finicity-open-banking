...
class VoaWithIncomeReportConstraints(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerVoaWithIncomeReportConstraints(pydantic.BaseModel):
    """
    Serializer for VoaWithIncomeReportConstraints handling case conversions
    and file omitions as dictated by the API
    """
