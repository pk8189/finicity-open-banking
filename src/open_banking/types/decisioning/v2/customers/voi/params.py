...
class VoiReportConstraints(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerVoiReportConstraints(pydantic.BaseModel):
    """
    Serializer for VoiReportConstraints handling case conversions
    and file omitions as dictated by the API
    """
