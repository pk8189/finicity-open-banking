...
class CashFlowReportConstraints(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerCashFlowReportConstraints(pydantic.BaseModel):
    """
    Serializer for CashFlowReportConstraints handling case conversions
    and file omitions as dictated by the API
    """
