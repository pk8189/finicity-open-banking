...
class FixConnectParameters(typing_extensions.TypedDict):
    """
    ...
    institution_login_id: typing_extensions.Required[str]
...
class _SerializerFixConnectParameters(pydantic.BaseModel):
    """
    Serializer for FixConnectParameters handling case conversions
    ...
    institution_login_id: str = pydantic.Field(alias="institutionLoginId")
