...
class ConnectEmailParameters(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerConnectEmailParameters(pydantic.BaseModel):
    """
    Serializer for ConnectEmailParameters handling case conversions
    and file omitions as dictated by the API
    """
