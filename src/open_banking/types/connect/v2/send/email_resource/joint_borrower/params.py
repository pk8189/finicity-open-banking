...
class EmailOptions(typing_extensions.TypedDict):
    """
    Configuration for the Connect email&#x27;s sent to customers
    """

    first_name: typing_extensions.NotRequired[str]
    from_field: typing_extensions.NotRequired[str]
    institution_address: typing_extensions.NotRequired[str]
    institution_name: typing_extensions.NotRequired[str]
    signature: typing_extensions.NotRequired[typing.List[str]]
    subject: typing_extensions.NotRequired[str]
    support_phone: typing_extensions.NotRequired[str]
    to: typing_extensions.Required[str]


class _SerializerEmailOptions(pydantic.BaseModel):
    """
    Serializer for EmailOptions handling case conversions
    and file omitions as dictated by the API
    """
...
class ConnectJointBorrowerEmailParameters(typing_extensions.TypedDict):
    """
    No description specified
    """

    borrowers: typing_extensions.Required[typing.List[Borrower]]
    email_field: typing_extensions.Required[EmailOptions]
    experience: typing_extensions.Required[str]
...
class _SerializerConnectJointBorrowerEmailParameters(pydantic.BaseModel):
    """
    Serializer for ConnectJointBorrowerEmailParameters handling case conversions
    and file omitions as dictated by the API
    """
    ...
    email_field: _SerializerEmailOptions = pydantic.Field(alias="email")
    experience: str = pydantic.Field(alias="experience")
