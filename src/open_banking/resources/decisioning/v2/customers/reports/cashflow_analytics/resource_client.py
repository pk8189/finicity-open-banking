...
from open_banking.resources.decisioning.v2.customers.reports.cashflow_analytics.user_types import (
    UserTypesClient,
    AsyncUserTypesClient,
)


class CashflowAnalyticsClient:
...
class AsyncCashflowAnalyticsClient:
