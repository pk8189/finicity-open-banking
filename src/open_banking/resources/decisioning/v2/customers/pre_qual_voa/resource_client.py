...
from open_banking.types.decisioning.v2.customers.pre_qual_voa import params
import typing


class PreQualVoaClient:
    ...
    def create(
        ...
        *,
        ...
        return self._base_client.request(
            method="POST",
            path=f"/decisioning/v2/customers/{customer_id}/preQualVoa",
