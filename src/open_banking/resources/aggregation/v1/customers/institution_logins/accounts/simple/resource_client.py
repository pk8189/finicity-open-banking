...
import typing
from open_banking.types.aggregation.v1.customers.institution_logins.accounts.simple import (
    models,
)
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/aggregation/v1/customers/{customer_id}/institutionLogins/{institution_login_id}/accounts/simple",
