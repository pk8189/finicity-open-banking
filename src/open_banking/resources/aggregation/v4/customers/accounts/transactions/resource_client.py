...
import typing
from open_banking.types.aggregation.v4.customers.accounts.transactions import models
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/aggregation/v4/customers/{customer_id}/accounts/{account_id}/transactions",
